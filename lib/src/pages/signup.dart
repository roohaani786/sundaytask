...
import 'package:sundaytask/src/pages/setpassword.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                 ...
                 Align(
                   ...
                   child: Text(
                     "Register an account/ Login with Phonenumber",
                  ...
                  Padding(
                    ...
                    child: FlatButton(
                      child: Text("Get OTP/SignUp",style: Theme.of(context).textTheme.button.merge(TextStyle(fontSize: 18.0,color: Colors.blueAccent))) ,
